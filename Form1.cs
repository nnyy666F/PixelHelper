...
namespace PixelHelper
{
	public partial class Form1 : Form
	{
		...
		{
			var str = $"画布尺寸：{canvasWidth}x{canvasHeight}px\n";
			str += $"画布大小：{canvasWidth / 2.54f:0.00}cm x {canvasHeight / 2.54f:0.00}cm\n";
			str += $"画布分辨率：{canvasWidth / horizontalSpacing:0.00}x{canvasHeight / verticalSpacing:0.00}px/mm\n";
			if (canvasWidth <= 0 && canvasHeight <= 0)
			{
				str = "";
			}
			MessageBox.Show("版本:v0.11\n" + str, "帮助", MessageBoxButtons.OK, MessageBoxIcon.Information);
		}
